...
export const HoneycombBackground: React.FC<{
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 font-sans flex flex-col overflow-x-hidden relative text-amber-950 selection:bg-amber-400 selection:text-amber-950">
