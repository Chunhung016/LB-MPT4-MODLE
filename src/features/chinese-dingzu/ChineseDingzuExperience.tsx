...
export function ChineseDingzuExperience({ onExit }: { onExit: () => void }) {
  // Game states: 
  // 0: Welcome Screen
    ...
    <div className="min-h-screen bg-[#FFF9F2] font-sans text-[#4A3428] flex flex-col overflow-x-hidden selection:bg-rose-200 selection:text-rose-800 relative">
      ...
      <nav className="relative z-10 h-20 bg-[#FFD7BA] border-b-4 border-[#F4A261] flex items-center justify-between px-4 sm:px-8 shadow-sm shrink-0">
        <div className="flex items-center gap-3">
          <button
            onClick={onExit}
            className="flex cursor-pointer items-center gap-1.5 rounded-full border-2 border-[#E76F51] bg-white px-3 py-1.5 text-xs font-black text-[#E76F51] shadow-[2px_2px_0_rgba(231,111,81,1)] transition-transform active:translate-y-0.5 hover:bg-orange-50 mr-2"
            aria-label="返回"
          >
