...
export const AdminDashboard: React.FC = () => {
  ...
  const [imageUrl, setImageUrl] = useState<string>(settings.poster.imageUrl || '');
        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-amber-200">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-lg font-black text-amber-950">Settings & Poster Image</h3>
          ...
          <div className="py-4 overflow-y-auto space-y-4 text-xs sm:text-sm">
            ...
            <div className="bg-amber-50/70 border border-amber-200 rounded-2xl p-3.5 space-y-2">
              <label className="font-bold text-amber-950 flex items-center gap-1.5">
                ...
                <span>Poster Illustration Image URL:</span>
              </label>
              <input
                type="url"
                value={imageUrl}
              ...
              <p className="text-[11px] text-amber-700">
                Paste any image URL to display your illustration inside the Story Explorer Saturday poster.
              </p>
            </div>
