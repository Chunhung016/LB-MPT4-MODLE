    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4.5 bg-slate-900/90 border-b border-slate-800 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              id="logic-settings-admin-btn"
              href="/admin"
              className="px-3 py-1 rounded-lg text-xs font-mono bg-amber-500/20 border border-amber-500/50 hover:bg-amber-500/30 text-amber-300 transition-colors cursor-pointer flex items-center gap-1.5"
              title="Open Admin & Parent Credentials Portal"
            >
