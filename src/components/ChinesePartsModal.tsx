...
const CHINESE_PARTS = [
  { id: 'jia', label: 'BAHAGIAN A', sublabel: '甲组 · 基础', icon: BookOpen, available: true },
  { id: 'yi', label: 'BAHAGIAN B', sublabel: '乙组 · 阅读理解', icon: PencilLine, available: true },
  { id: 'bing', label: 'BAHAGIAN C', sublabel: '丙组 · 供料作文', icon: Languages, available: false },
  { id: 'ding', label: 'BAHAGIAN D', sublabel: '丁组 · 命题作文', icon: Sparkles, available: false },
];
      ...
      >
        <header className="flex items-center justify-between border-b border-[#FDE68A] bg-[#FEF3C7] px-5 py-4 sm:px-6 sm:py-5">
          ...
          <button
            ...
            aria-label="Close Chinese parts"
          >
            <X className="h-5 w-5" />
          </button>
        </header>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    />
                    {part.available ? (
                      <div className="absolute -right-3 -top-2 rounded-full border-2 border-white bg-emerald-500 px-2 py-0.5 text-[9px] font-black text-white shadow-sm">
                        READY
                      </div>
                    ) : (
